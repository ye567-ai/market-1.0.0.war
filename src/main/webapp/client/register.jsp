...
<script type="text/javascript">
	function changeImage() {
		...
		// 设置图片的src属性，时间戳作为参数，以确保每次请求都是新的图片
		document.getElementById("img").src = "${pageContext.request.contextPath}/imageCode?timestamp=" + timestamp;
	}
</script>
</head>
						...
						<table width="70%" border="0" cellspacing="0">
							<tr>
								<td style="padding-top: 20px; text-align: center">
									<input type="image" src="images/signup.gif" name="submit" border="0" width="140" height="35" alt=""/>
								</td>
							</tr>
						</table>
					</td>
