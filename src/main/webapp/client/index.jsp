...
<body class="main">
	...
	<div id="box_autoplay">
    	<div class="list">
        	<ul>
            	<li><img src="${pageContext.request.contextPath }/client/ad/index_ad1.jpeg" width="900" height="335"  alt=""/></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/index_ad2.jpeg" width="920" height="335" alt=""/></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/index_ad3.jpeg" width="900" height="335"  alt=""/></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/index_ad4.jpeg" width="900" height="335"  alt=""/></li>
            	<li><img src="${pageContext.request.contextPath }/client/ad/index_ad5.jpeg" width="900" height="335"  alt=""/></li>
        	</ul>
    	</div>
	</div>
	<!-- 商品商场首页轮播图  end -->
			...
			<tr>
				...
				<td style="padding:5px 15px 10px 40px">
					<table width="100%" border="0" cellspacing="0">
						<tr>
							<td>
								<img src="${pageContext.request.contextPath}/client/images/hottitle.gif" width="126" height="29"  alt=""/>
							</td>
						</tr>
					</table>
					<table width="100%" border="0" cellspacing="0">
