						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff">
									<label for="Form_userName"></label><input type="text" name="id" size="15" value="" id="Form_userName" class="bg" />
								</td>
							...
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff">
									<label for="Form1_userName"></label><input type="text" name="name" size="15" value="" id="Form1_userName" class="bg" />
								</td>
				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
                            ...
                            <!--  循环输出所有商品 -->
							<jsp:useBean id="ps" scope="request" type="java.util.List"/>
