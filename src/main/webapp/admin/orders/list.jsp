						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff">
									<label for="Form1_userName"></label><input type="text" name="id" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									收件人：</td>
								<td class="ta_01" bgColor="#ffffff">
									<label for="Form_userName"></label><input type="text" name="receiverName" size="15" value="" id="Form_userName" class="bg" />
								</td>
							</tr>
							<tr>
									...
									<td align="center" style="HEIGHT: 22px">
									    ...
									    <c:if test="${order.paystate!=0 }">
											<a href="${pageContext.request.contextPath}/delOrderById?id=${order.id}&type=admin" onclick="javascript:return o_del()">
												<img src="${pageContext.request.contextPath}/admin/images/i_del.gif" width="16" height="16" border="0" style="CURSOR: hand" alt="">
											</a>
										</c:if> 
										<!--  未支付 ，不能删除-->
										<c:if test="${order.paystate==0 }">
